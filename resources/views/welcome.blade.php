                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 lg:col-span-2">
                        <div class="flex">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold w-full">
                                ...
                                <div class="mt-4 relative lg:w-2/3">
                                    <form class="flex xl:flex-row flex-col">
                                        <input type="email" name="email" placeholder="your@emai.com" required=""
                                               class="rounded-sm ring-2 ring-blue-200 focus:ring-blue-500 outline-none
                                        ...
                                        <button class="text-white focus:ring-offset-2 focus:ring-offset-2
                                            ...
                                            mt-4 xl:mt-0 xl:ml-4 shadow-md px-6 py-3">Subscribe</button>
                                    </form>
                                </div>
                            </div>
                        </div>
