<div class="mt-3 relative lg:w-1/2">
    ...
    <form class="flex mt-1 xl:flex-row flex-col">
        ...
        <button
            class="text-white focus:ring-offset-2 focus:ring-offset-2 focus:ring focus:ring-blue-400 focus:outline-none rounded-sm bg-blue-500 mt-4 xl:mt-0 xl:ml-4 shadow-md px-6 py-2">
            Subscribe
        </button>
    </form>
</div>
